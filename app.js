...
const APPS = [
  ...
  {id:'privacy-toolkit',name:'Privacy Toolkit',desc:'17 browser-based security tools. Phishing detection, AES-256 encryption, JWT decoder.',icon:'\u{1F512}',color:'#0f3a2a',category:'Security',url:'https://privacy-toolkit-ten.vercel.app'},
